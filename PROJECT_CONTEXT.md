...
## 0. Приоритетный мастер-контекст публичного B2C-бренда

Для любых задач публичного B2C-контура приоритетным источником истины является Google Doc:

- [«Семейно. Мастер-контекст бренда и проекта»](https://docs.google.com/document/d/1JZhsFw5d_fGJz5rEr-6GvVevUKrmtKawo8JpF0hm3VI/edit)
- статус документа: утверждённый мастер-контекст;
- версия: 1.0;
- дата фиксации: 24 июля 2026 года;
- локальная рабочая выжимка: `docs/b2c/SEMEYNO_MASTER_CONTEXT.md`.

Правило приоритета: если старые формулировки в репозитории расходятся с мастер-контекстом «Семейно», для публичного B2C применять мастер-контекст. Не переносить правила бренда «Семейно» на B2B SaaS и не менять утверждённые решения без прямого запроса владельца.

## 1. Что такое Luma IQ

Luma IQ состоит из двух контуров.

1. Public B2C: самостоятельный публичный бренд «Семейно» — пространство для всей семьи. Он временно работает на техническом домене Luma IQ, но публично не связан с брендом Luma IQ. Включает SEO-медиа, программы, тесты, психологов, консультации, диагностики и будущие групповые/офлайн-форматы.
...
Публичный бренд: `Семейно`.

- дескриптор: `Пространство для семьи`;
- главная идея: `Семья — это навык. Мы учимся ему всю жизнь`;
- центральный объект: отношения внутри всей семейной системы — пары, родители, дети и подростки;
- публично не связывать «Семейно» с Luma IQ;
- не позиционировать проект как клинику, детскую академию, онлайн-школу для мам или каталог психологов;
- не обещать идеальную или обязательно сохранённую семью;
- тон: взрослый, спокойный, ясный, тактичный, профессиональный, человечный и неосуждающий;
- контент должен объяснять механизм, границы безопасности и следующий практический шаг.
...
Positioning: «Семейно» помогает родителям, детям и парам развивать навыки отношений, лучше понимать друг друга и проходить семейные изменения без обвинений, стигмы и требования быть идеальной семьёй. Психология — инструмент, а не абстрактный товар.
...
AI Infrastructure V2 rollout:

- backend flags, action allowlist and explicit users control access;
- ordinary users enter V2 through a deterministic rollout percentage;
- the first production release is admin-first, not an immediate 100% switch;
- stale AI-point reservations are settled by the maintenance sweeper;
- rollout and rollback instructions are in `docs/ai-audit-v2/STAGE_12_PRODUCTION_ROLLOUT_RUNBOOK.md`.
