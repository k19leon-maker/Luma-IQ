...
жёстким шаблоном или списком. Раздели его на 3–5 коротких смысловых абзацев и
оставляй между абзацами пустую строку (\\n\\n). Верни только один валидный JSON-объект.`;

const UTP_JSON_CONTRACT = `Верни строго JSON без markdown и дополнительных ключей:
{
  "usp": "связный текст УТП длиной 500–1200 символов, разделённый на 3–5 абзацев через \\n\\n",
  "usedEvidence": [
