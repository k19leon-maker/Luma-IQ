...
export const env = {
  ...
  SEMEYNO_AI_RELAY_SECRET: get('SEMEYNO_AI_RELAY_SECRET', ''),
  ...
  TELEGRAM_BOT_SPREADSHEET_ID: get('TELEGRAM_BOT_SPREADSHEET_ID', ''),
  TELEGRAM_BOT_TEST_MODE: getBool('TELEGRAM_BOT_TEST_MODE', true),
  TELEGRAM_BOT_TEST_USER_IDS: get('TELEGRAM_BOT_TEST_USER_IDS', ''),
  TELEGRAM_BOT_SCHEDULER_INTERVAL_MS: Math.max(10_000, getNumber('TELEGRAM_BOT_SCHEDULER_INTERVAL_MS', 30_000)),
  TELEGRAM_WEBHOOK_BASE_URL: get('TELEGRAM_WEBHOOK_BASE_URL', ''),
  TELEGRAM_TOKEN_ENCRYPTION_KEYS: get('TELEGRAM_TOKEN_ENCRYPTION_KEYS', ''),
  TELEGRAM_TOKEN_ACTIVE_KEY_VERSION: Math.max(1, Math.floor(getNumber('TELEGRAM_TOKEN_ACTIVE_KEY_VERSION', 1))),
  TELEGRAM_RUNTIME_V2_ENABLED: getBool('TELEGRAM_RUNTIME_V2_ENABLED', false),
  TELEGRAM_RUNTIME_V2_ALLOWED_BOT_IDS: get(
    'TELEGRAM_RUNTIME_V2_ALLOWED_BOT_IDS',
    get('NODE_ENV', 'development') === 'production' ? '' : '*',
  ),
  TELEGRAM_RUNTIME_POLL_INTERVAL_MS: Math.max(250, getNumber('TELEGRAM_RUNTIME_POLL_INTERVAL_MS', 1_000)),
  TELEGRAM_RUNTIME_BATCH_SIZE: Math.min(100, Math.max(1, Math.floor(getNumber('TELEGRAM_RUNTIME_BATCH_SIZE', 20)))),
  TELEGRAM_RUNTIME_LOCK_TIMEOUT_SECONDS: Math.max(30, Math.floor(getNumber('TELEGRAM_RUNTIME_LOCK_TIMEOUT_SECONDS', 300))),
  ...
  TELEGRAM_CONFERENCE_SHEETS_ENABLED: getBool('TELEGRAM_CONFERENCE_SHEETS_ENABLED', false),
  TELEGRAM_CONFERENCE_SHEETS_BOT_ID: get('TELEGRAM_CONFERENCE_SHEETS_BOT_ID', ''),
  TELEGRAM_CONFERENCE_SHEETS_SPREADSHEET_ID: get('TELEGRAM_CONFERENCE_SHEETS_SPREADSHEET_ID', ''),
  TELEGRAM_CONFERENCE_SHEETS_TEST_USER_IDS: get('TELEGRAM_CONFERENCE_SHEETS_TEST_USER_IDS', ''),
  TELEGRAM_CONFERENCE_SHEETS_TEST_USERNAMES: get('TELEGRAM_CONFERENCE_SHEETS_TEST_USERNAMES', ''),

  // Official Luma IQ assistant. It never uses customer TelegramBot records.
  SYSTEM_TELEGRAM_ENABLED: getBool('SYSTEM_TELEGRAM_ENABLED', false),
  SYSTEM_TELEGRAM_WORKER_ENABLED: getBool('SYSTEM_TELEGRAM_WORKER_ENABLED', false),
  SYSTEM_TELEGRAM_BOT_TOKEN: get('SYSTEM_TELEGRAM_BOT_TOKEN', ''),
  SYSTEM_TELEGRAM_WEBHOOK_SECRET: get('SYSTEM_TELEGRAM_WEBHOOK_SECRET', ''),
  SYSTEM_TELEGRAM_ALLOWED_USER_IDS: get('SYSTEM_TELEGRAM_ALLOWED_USER_IDS', ''),
  SYSTEM_TELEGRAM_ALLOW_ALL: getBool('SYSTEM_TELEGRAM_ALLOW_ALL', false),
  SYSTEM_TELEGRAM_POLL_INTERVAL_MS: Math.max(250, getNumber('SYSTEM_TELEGRAM_POLL_INTERVAL_MS', 1_000)),
  SYSTEM_TELEGRAM_BATCH_SIZE: Math.min(50, Math.max(1, Math.floor(getNumber('SYSTEM_TELEGRAM_BATCH_SIZE', 10)))),
  SYSTEM_TELEGRAM_LOCK_TIMEOUT_SECONDS: Math.max(30, Math.floor(getNumber('SYSTEM_TELEGRAM_LOCK_TIMEOUT_SECONDS', 300))),
