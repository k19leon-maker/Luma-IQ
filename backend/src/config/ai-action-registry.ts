...
export const LEGACY_FEATURE_TO_ACTION: Record<string, AIActionKey> = {
  ...
  instagram_highlights_generate: 'instagram_highlights_generate',
  instagram_highlight_scenario_generate: 'instagram_highlight_scenario_generate',
  instagram_highlight_improve: 'instagram_highlight_improve',
  instagram_story_improve: 'instagram_story_improve',
