...
1. **Основной продукт**
   ...
   - Блочный конструктор: 3 варианта названия, оффер и описание, список модулей + редактор выбранного модуля, чат с ИИ по модулю, общий результат и тарифы.
...
- Раздел “Основной продукт” переведен в блочный конструктор: 3 варианта названия, оффер, описание, управляемое число модулей, редактор выбранного модуля с чатом ИИ, общий результат продукта, тарифы Эконом/Стандарт/VIP и проверка с ИИ.
