...
- Раздел “Основной продукт” переведен в блочный конструктор: оффер, описание, 10 модулей, результат каждого модуля, общий результат продукта, тарифы Эконом/Стандарт/VIP и проверка с ИИ.
