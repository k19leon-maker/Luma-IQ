...
1. **Основной продукт**
   ...
   - Блочный конструктор: 3 варианта названия, оффер и описание, редактируемые модули с добавлением/удалением, общий результат и тарифы.
...
- Раздел “Основной продукт” переведен в блочный конструктор: 3 варианта названия, оффер, описание, управляемое число модулей, результат каждого модуля, общий результат продукта, тарифы Эконом/Стандарт/VIP и проверка с ИИ.
