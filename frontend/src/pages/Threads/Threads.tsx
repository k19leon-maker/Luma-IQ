...
const LIMIT_MESSAGE = 'AI-баланс закончился. Вы можете открыть ранее сохранённые Threads-планы, но новое AI-действие будет доступно после обновления лимитов или смены тарифа.';
